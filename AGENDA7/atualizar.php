...
<div class="w3-padding w3-content w3-text-grey w3-third w3-margin w3-displaymiddle"><h1 class="w3-center w3-deep-purple w3-round-large w3-margin">Atualizar -
...
<br>
<label class="w3-text-deep-purple " style="fontweight: bold;">Nome</label>
<input name="txtNome" class="w3-input w3-light-grey w3-border" value="<?php echo $_GET['nome']?>">
<br>
<label class="w3-text-deep-purple " style="fontweight: bold;">Preço</label>
<input name="txtPreco" class="w3-input w3-light-grey w3-border" value="<?php echo $_GET['preco']?>">
<br>
<label class="w3-text-deep-purple " style="fontweight: bold;">Quantidade</label>
