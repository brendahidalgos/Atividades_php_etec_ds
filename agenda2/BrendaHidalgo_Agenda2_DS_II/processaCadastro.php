    ...
    <section class="resection">        
        <div class="reform">
            ...
            <ul class="reul">
                ...
                <li>Frameworks - desenvolvo a maioria das vezes em css puro, não consegui ainda ter prática com os códigos do W3schools.</li>
                <br>
            ...
            <br>
            <p class="rep">Como decidiu organizar os dados no formulário.</p>
            <p style="text-align:left;">Eu pensei em como uma pessoa faria esse cadastro e quais os dados principais um recrutador precisaria. Porém para mim faltou Estado e Cidade se fosse uma empresa nacional e não regional.</p>
